                  ...
                  <div class="row">
                    <div class="col-sm-7">
                      <div class="d-flex align-items-center mb-7">
                        ...
                        <h5 class="fw-semibold mb-0 fs-5">Ini udah pindah di test sii!</h5>
                      </div>
                    ...
                    <div class="col-4">
                      <div class="d-flex justify-content-end">
                        <div class="p-2 bg-light-primary rounded-2 d-inline-block">
                          <img src="{{ asset('assets/images/svgs/icon-master-card-2.svg') }}" alt="" class="img-fluid" width="24" height="24">
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                      <div class="d-flex">
                        <div class="p-8 bg-light-primary rounded-2 d-flex align-items-center justify-content-center me-6">
                          <img src="{{ asset('assets/images/svgs/icon-paypal2.svg') }}" alt="" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                      <div class="d-flex">
                        <div class="p-8 bg-light-success rounded-2 d-flex align-items-center justify-content-center me-6">
                          <img src="{{ asset('assets/images/svgs/icon-wallet.svg') }}" alt="" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                      <div class="d-flex">
                        <div class="p-8 bg-light-warning rounded-2 d-flex align-items-center justify-content-center me-6">
                          <img src="{{ asset('assets/images/svgs/icon-credit-card.svg') }}" alt="" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-7 pb-1">
                      <div class="d-flex">
                        <div class="p-8 bg-light-danger rounded-2 d-flex align-items-center justify-content-center me-6">
                          <img src="{{ asset('assets/images/svgs/icon-pie2.svg') }}" alt="" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
                      ...
                      <tbody class="border-top">
                        <tr>
                          <td class="ps-0">
                            <div class="d-flex align-items-center">
                              <div class="me-2 pe-1">
                                <img src="{{ asset('assets/images/products/product-1.jpg') }}" class="rounded-2" width="48" height="48" alt="" />
                              </div>
                              <div>
                        ...
                        <tr>
                          <td class="ps-0">
                            <div class="d-flex align-items-center">
                              <div class="me-2 pe-1">
                                <img src="{{ asset('assets/images/products/product-2.jpg') }}" class="rounded-2" width="48" height="48" alt="" />
                              </div>
                              <div>
                        ...
                        <tr>
                          <td class="ps-0">
                            <div class="d-flex align-items-center">
                              <div class="me-2 pe-1">
                                <img src="{{ asset('assets/images/products/product-3.jpg') }}" class="rounded-2" width="48" height="48" alt="" />
                              </div>
                              <div>
                        ...
                        <tr>
                          <td class="ps-0 border-bottom-0">
                            <div class="d-flex align-items-center">
                              <div class="me-2 pe-1">
                                <img src="{{ asset('assets/images/products/product-4.jpg') }}" class="rounded-2" width="48" height="48" alt="" />
                              </div>
                              <div>
